...
curl -X POST localhost:8080/api/v1/users -d '{}' 
curl -X DELETE localhost:8080/api/v1/users/1 
curl -X PUT localhost:8080/api/v1/users/1 -d '{}'
...
curl -x POST localhost:8080/api/v1/ships/1   # userid  ship
curl -x DELETE localhost:8080/api/v1/ships/1/1   # userid  shipid 
curl -x PUT localhost:8080/api/v1/ships/1    # userid  ship 


# ship track point apis 
curl -x GET localhost:8080/api/v1/shiptracks/1   # shipId 
curl -X POST localhost:8080/api/v1/shiptracks/1 -d '{}' # shipId  ShipTrackPoint  
